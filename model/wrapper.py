...
from model import embedding, linformer
...
class LinformerLRASingle(nn.Module):
    def __init__(self, args) -> None:
        super(LinformerLRASingle, self).__init__()
        self.embedding = embedding.LinformerEmbedding(args.pe_type, 
                                                      args.pooling_type, 
                                                      args.vocab_size, 
                                                      args.max_seq_len, 
                                                      args.embed_size, 
...
class LinformerLRADual(nn.Module):
    def __init__(self, args) -> None:
        super(LinformerLRADual, self).__init__()
        self.embedding = embedding.LinformerEmbedding(args.pe_type, 
                                                      args.pooling_type, 
                                                      args.vocab_size, 
                                                      args.max_seq_len, 
